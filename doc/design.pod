...
Coupons are attached to consumers.  When the consumer is activated, it tells
its coupon how much money it wants and the coupon will create and return a
credit.  That credit's value to fund the consumer is used before any other
funds.
