...
number of piggy banks, consumers, receipts, and invoices.  It also singles out
...
A receipt represents a summary of transfers made from banks to consumers over a
span of time.  It is represented as the head of a cost tree.  A receipt can be
